...
function Home() {
  ...
  return (
    <div>
      ...
      <Offer />
      <FoodCard
        subTitle={"Explore your categories"}
        mainTitle={"What's your choice today?"}
        data={category}
      />
      <div className="category-border">
        ...
        <div className="category-container">
          {orders.length === 0 ? (
            <p className="text-center text-muted mt-5 mb-5 left-50">
              No Items found
            </p>
          ) : (
            orders.map((item) =>
              item.items.map((order) => (
                ...
                >
                  ...
                  <img
                    src={order.image}
                    alt={order.name}
                    className="category-img cursor-p"
                  />
                </div>
              ))
            )
